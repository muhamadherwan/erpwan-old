...
{{--                    </x-nav-link>--}}
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('invoices.index')" :active="request()->routeIs('invoice.index')">
                                {{ __('List') }}
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('invoices.create')" :active="request()->routeIs('invoice.create')">
                                {{ __('Create New') }}
                            </x-dropdown-link>
